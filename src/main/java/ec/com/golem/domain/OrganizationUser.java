...
public class OrganizationUser implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "organizationUsers" }, allowSetters = true)
    private Organization organization;

    @ManyToOne(fetch = FetchType.LAZY)
    @JsonIgnoreProperties(value = { "organizationUsers", "errorLogs" }, allowSetters = true)
    private UserX user;
    ...
    public OrganizationUser user(UserX userX) {
        this.setUser(userX);
        return this;
    }
