...
public class ActionGenericResource {
    ...
    private final ActionGenericService actionGenericService;

    private final ActionGenericRepository actionGenericRepository;

    public ActionGenericResource(ActionGenericService actionGenericService, ActionGenericRepository actionGenericRepository) {
        this.actionGenericService = actionGenericService;
    ...
    public ResponseEntity<ActionGeneric> createActionGeneric(@RequestBody ActionGeneric actionGeneric) throws URISyntaxException {
        ...
        ActionGeneric result = actionGenericService.save(actionGeneric);
    ...
    public ResponseEntity<ActionGeneric> updateActionGeneric(
        ...
        ActionGeneric result = actionGenericService.update(actionGeneric);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ActionGeneric> partialUpdateActionGeneric(
        ...
        Optional<ActionGeneric> result = actionGenericService.partialUpdate(actionGeneric);
    ...
    public List<ActionGeneric> getAllActionGenerics() {
        ...
        return actionGenericService.findAll();
    }
    ...
    public ResponseEntity<ActionGeneric> getActionGeneric(@PathVariable("id") Long id) {
        ...
        Optional<ActionGeneric> actionGeneric = actionGenericService.findOne(id);
    ...
    public ResponseEntity<Void> deleteActionGeneric(@PathVariable("id") Long id) {
        ...
        actionGenericService.delete(id);
        return ResponseEntity
            .noContent()
    ...
    public List<ActionGeneric> searchActionGenerics(@RequestParam("query") String query) {
        ...
        try {
            return actionGenericService.search(query);
