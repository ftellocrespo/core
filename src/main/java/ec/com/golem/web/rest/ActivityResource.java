...
/**
 * REST controller for managing {@link ec.com.golem.domain.Activity}.
 */
@RestController
...
public class ActivityResource {
    ...
    /**
     * {@code SEARCH  /activities/_search?query=:query} : search for the activity corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public List<Activity> searchActivities(@RequestParam("query") String query) {
