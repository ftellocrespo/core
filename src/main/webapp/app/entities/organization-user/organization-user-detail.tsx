    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="coreApp.organizationUser.organization">Organization</Translate>
          </dt>
          <dd>{organizationUserEntity.organization ? organizationUserEntity.organization.id : ''}</dd>
          <dt>
            <Translate contentKey="coreApp.organizationUser.user">User</Translate>
          </dt>
          <dd>{organizationUserEntity.user ? organizationUserEntity.user.id : ''}</dd>
        </dl>
