...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organization-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ORGANIZATIONUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ORGANIZATIONUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORGANIZATIONUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORGANIZATIONUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORGANIZATIONUSER actions', async () => {
      const expectedActions = [
        {
