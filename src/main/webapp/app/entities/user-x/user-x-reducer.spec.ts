...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERX_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERXES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERX actions', async () => {
      const expectedActions = [
        {
