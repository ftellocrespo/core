          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="coreApp.errorLog.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {errorLogList.map((errorLog, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{errorLog.user ? <Link to={`/user-x/${errorLog.user.id}`}>{errorLog.user.id}</Link> : ''}</td>
