...
const apiSearchUrl = 'api/organizations/_search';

// Actions

export const searchEntities = createAsyncThunk('organization/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
  const requestUrl = `${apiSearchUrl}?query=${query}`;
  return axios.get<IOrganization[]>(requestUrl);
});

export const getEntities = createAsyncThunk('organization/fetch_entity_list', async ({ sort }: IQueryParams) => {
