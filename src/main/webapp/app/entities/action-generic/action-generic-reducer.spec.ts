...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIONGENERIC_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACTIONGENERICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACTIONGENERIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIONGENERIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIONGENERIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIONGENERIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIONGENERIC actions', async () => {
      const expectedActions = [
        {
